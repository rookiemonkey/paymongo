...
require 'paymongo/api/v1/config'
require 'paymongo/api/v1/payment_intent/payment_intent'
require 'paymongo/api/v1/payment_method/payment_method'
require 'paymongo/api/v1/payments/payments'
require 'paymongo/api/v1/sources/sources'
require 'paymongo/api/v1/tokens/tokens'
require 'paymongo/api/v1/webhooks/webhooks'
require 'paymongo/api'
